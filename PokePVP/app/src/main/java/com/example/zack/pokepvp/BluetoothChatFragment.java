...
public class BluetoothChatFragment extends Fragment {
    ...
    public void copy(BluetoothChatFragment rhs, int activityCode) {
        ...
        this.mainActivity = rhs.mainActivity;
    }

    public void copy(BluetoothChatFragment rhs, int activityCode, Handler mHandle) {
        this.activityNum = activityCode;
        this.mBluetoothAdapter = rhs.mBluetoothAdapter;
        this.mChatService = rhs.mChatService;
        this.mConnectedDeviceName = rhs.mConnectedDeviceName;
        this.mOutStringBuffer = rhs.mOutStringBuffer;
        this.mChatService.changeHandler(mHandle);
        this.mainActivity = rhs.mainActivity;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.MESSAGE_READ:
                    ...
                    if(activityNum == 1) {
                        MainBattle mActivity = (MainBattle) getActivity();
                        mActivity.parse(readMessage);
                    } else if(activityNum == 0) {
                        MainActivity mActivity = (MainActivity) getActivity();
                        mActivity.set(readMessage);
                    }
                    break;
        ...
        switch (requestCode) {
            ...
            case REQUEST_ENABLE_BT:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(getMainActivity(), R.string.bt_not_enabled_leaving,
                            Toast.LENGTH_SHORT).show();
                    getActivity().finish();
                }
        }
